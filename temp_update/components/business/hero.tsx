...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-40 top-1/4 h-[600px] w-[600px] rounded-full bg-[#00ffb4]/[0.08] blur-[120px] animate-orb-float"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-40 top-1/2 h-[500px] w-[500px] rounded-full bg-[#7b2fff]/[0.06] blur-[100px] animate-orb-float-slow"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/3 bottom-0 h-[400px] w-[400px] rounded-full bg-[#00d4ff]/[0.05] blur-[80px] animate-orb-float delay-500"
      />
      ...
      >
        <div className="absolute inset-x-0 top-0 h-[50%] bg-gradient-to-b from-transparent via-[#00ffb4]/[0.04] to-transparent blur-2xl animate-scan-beam" />
      </div>

      {/* Content */}
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 text-center">
        {/* Badge */}
        <div className="animate-fade-up mb-8 inline-flex items-center gap-2 rounded-full border border-[#00ffb4]/30 bg-[#00ffb4]/10 px-4 py-2 text-sm font-medium text-[#00ffb4] backdrop-blur-sm">
          <Sparkles className="h-4 w-4" />
          <span>Powered by AI</span>
          <span className="h-2 w-2 rounded-full bg-[#00ffb4] animate-pulse-dot" />
        </div>
        ...
        <h1 className="animate-fade-up delay-100 font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6">
          ...
          <span className="text-[#e8f0fe]">Business</span>
        </h1>

        {/* Typewriter subheadline */}
        <div className="animate-fade-up delay-200 h-12 sm:h-14 mb-8 flex items-center justify-center">
          <p className="font-mono text-lg sm:text-xl md:text-2xl text-[#6b7c99]">
            <span className="text-[#00ffb4]">{displayText}</span>
            <span className="typing-caret" />
          </p>
        </div>

        {/* Description */}
        <p className="animate-fade-up delay-300 mx-auto max-w-2xl text-base sm:text-lg text-[#6b7c99] mb-10 leading-relaxed">
      ...
      <div
        aria-hidden
        className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#020409] to-transparent"
      />
    </section>
  )
}
