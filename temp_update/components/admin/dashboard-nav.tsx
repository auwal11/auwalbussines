...
export function DashboardNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 bg-[#0a0f1e]/90 backdrop-blur-xl border-b border-[#ffffff08]">
      <div className="h-full max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link href="/hidden-portal/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-display font-semibold text-[#e8f0fe] hidden sm:inline">
            Command Center
          </span>
        </Link>
              ...
              <Link
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                  isActive
                    ...
                    : "text-[#6b7c99] hover:text-[#e8f0fe] hover:bg-[#ffffff05]"
                }`}
              >
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[#ff3366] hover:bg-[#ff3366]/10 transition-colors"
        >
